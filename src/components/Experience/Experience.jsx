...
<div className="relative">
  ...
  <div className="absolute sm:left-1/2 left-6 top-0 w-1 bg-white h-full"></div>
        {experiences.map((experience, index) => (
          ...
          >
            {/* Timeline Circle */}
            <div className="sm:absolute sm:left-1/2 left-6 top-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-gray-400 border-4 border-[#8245ec] w-12 h-12 sm:w-16 sm:h-16 rounded-full flex justify-center items-center z-10">
              <img
                src={experience.img}
